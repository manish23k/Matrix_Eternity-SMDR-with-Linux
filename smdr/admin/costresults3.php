...
<div id="main" style="overflow-x:scroll;overflow-y:scroll;width:78%;height:90%">
		<h2 align="center" class="style1">Outgoing Calls(VoIP)</h2>
...
if ($select2 != ''){
$query = "SELECT SUM(cost), COUNT(cost) FROM ogvoip WHERE $select1 = '$param1' AND $select2 LIKE '$param2'AND $select3 = '$param3' ORDER BY id ASC"; 
$result = mysqli_query($con, $query);
}
else {
$query = "SELECT SUM(cost), COUNT(cost) FROM ogvoip WHERE $select1 = '$param1'AND $select3 = '$param3' ORDER BY id ASC";
$result = mysqli_query($con, $query);
}
...
$param3= $_GET['selectvar3'];
if ($select2 != ''){
$query = "SELECT * FROM ogvoip WHERE $select1 = '$param1' AND $select2 LIKE '$param2' AND $select3 = '$param3' ORDER BY id ASC"; 
$result = mysqli_query($con, $query);
}
else {
$query = "SELECT * FROM ogvoip WHERE $select1 = '%$param1%'AND $select3 = '%$param3%' ORDER BY id ASC";
$result = mysqli_query($con, $query);
}
