    ...
    */  
    ...
    {  
        ...
        {  
            ...
            $query_test = mysqli_query("SELECT * FROM gldir WHERE name = '$excel_ext_num'  ");  
            if (mysqli_errno()) {   
            ...
            {  
                ...
                mysqli_query("UPDATE gldir SET name = '$excel_ext_name' WHERE id = '$testcase_id' ");
                if (mysqli_errno()) {   
                ...
                //*** Start Transaction ***//    
                mysqli_query("BEGIN");   
                $objQuery1 = mysqli_query("INSERT INTO gldir "."(number,name) "."VALUES('$excel_ext_num','$excel_ext_name')");  
...
<table>  
<tr><td>Use this page to import Global Directory from Excel sheet to Portal, Excel file should have following columns:</td></tr>  
</table>  
