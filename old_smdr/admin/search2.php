...
<div id="main" style="overflow: auto; ">
		<h2 align="center" class="style1">Search Incoming Calls</h2>
<form action="costresults2.php" method="get" name="Seach form">
    <p align="left">&nbsp;</p>
    <p><strong>Select search field:</strong> 
      <select name="select" size="1">
        <option value="month">Month (in digits)</option>
        <option value="day">Day (in digits)</option>
        <option value="calledno">Number dialed</option>
        <option value="callingparty">Caller</option>
        <option value="transferext">Extension</option>
		<option value="calltype">Call Type</option>
        <option value="hrs">Time (Hour of day only)</option>
      </select>
      <strong>Enter parameter:</strong> 
      <input name="selectvar" type="text" id="selectvar" size="10"value=<?php echo (int)(int)date("m") ?>>
    </p>
    <p><strong>Select second field:</strong> 
      ...
      <strong>Enter parameter:</strong> 
      <input name="selectvar2" type="text" id="selectvar2" size="10"value=<?php echo (int)(int)date("d") ?>>
    </p>
      ...
      <strong>Enter parameter:</strong>
      <input name="selectvar3" type="text" id="selectvar3" size="10" value=<?php echo (int)(int)date("Y") ?>>
    </p>
    <p> 
