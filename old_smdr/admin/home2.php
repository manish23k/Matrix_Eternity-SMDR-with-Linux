...
<table border="2" >
  <tr>
	...
	<td bgcolor="#666666" nowrap><div align="center"> <font size="-1"><strong style="color:#0099FF">Internal Calls</strong></font></div></td>
  </tr>
</table>
  <!-- prerequisites -->
...
AmCharts.loadJSON = function(url) {
  ...
  <h2 align="center" class="style1">Number of Internal Calls v/s Date (Current Month)</h2>
  <!-- chart container -->
...
AmCharts.ready(function() {
  ...
  // load the data
  var chartData = AmCharts.loadJSON('chart3.php');
