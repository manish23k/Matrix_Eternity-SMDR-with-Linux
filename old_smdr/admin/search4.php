...
<div id="main" style="overflow: auto;">
		<h2 align="center" class="style1">Search Incoming Calls(VoIP)</h2>
<form action="costresults4.php" method="get" name="Seach form">
    <p align="left">&nbsp;</p>
    ...
    <p><strong>Select second field:</strong> 
      ...
      <strong>Enter parameter:</strong>
      <input name="selectvar3" type="text" id="selectvar3" size="10" value=<?php echo (int)date("Y") ?>>
    </p>
    <p> 
